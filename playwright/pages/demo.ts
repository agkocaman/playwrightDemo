...
export class DemoPage {
    page: Page;
    homePageLabelx : Locator;
    homePageLabelxMarkette : Locator;
    homePageLabelxFinans : Locator;
    iconSearch : Locator;
    ...
    constructor(page: Page) {
        this.page = page
        this.homePageLabelx = page.locator('a[aria-label="x anasayfa"]')
        this.homePageLabelxMarkette = page.locator("a[aria-label='x markette']")
        this.homePageLabelxFinans = page.locator("div:has(>a[aria-label='x anasayfa']) > a:nth-of-type(3)")
        this.iconSearch = page.locator("div >.x-icon-search")
        ...
        this.saleDiscountIcon = page.locator("button>.x-icon-sale-discount-promotion")
        this.brochureIcon = page.locator("button>.x-icon-brochures")
        ...
        this.loginIcon = page.locator("button>.x-icon-avatar-login")
        ...
        this.loginBtnMobile = page.locator("a>.x-icon-avatar-login")
